...
<main>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(../public/images/slide1-01.png);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(../public/images/slide1-02.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(../public/images/slide1-01.png);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158" style="background-image: url(../public/images/bg-intro-01.jpg);">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url(../public/images/event-02.jpg);">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="fadeInDown">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg2-blo2" style="background-image: url(../public/images/event-06.jpg);">
									<div class="time-event size10 txt6 effect1">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="rotateInUpLeft">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg3-blo2" style="background-image: url(../public/images/event-01.jpg);">
									<div class="time-event size10 txt6 effect1">
										<span class="txt-effect1 flex-c-m">
											08:00 PM Tuesday - 21 November 2018
										</span>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="blog-detail.html"><img src="../public/images/blog-01.jpg" alt="IMG-INTRO"></a>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="blog-detail.html"><img src="../public/images/blog-02.jpg" alt="IMG-INTRO"></a>
				...
				<div class="col-md-4 p-t-30">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="blog-detail.html"><img src="../public/images/blog-03.jpg" alt="IMG-INTRO"></a>
